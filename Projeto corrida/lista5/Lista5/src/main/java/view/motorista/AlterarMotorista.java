...
public class AlterarMotorista extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        codigoMotorista = new javax.swing.JTextField();
        ...
        codigoMotorista.setMinimumSize(new java.awt.Dimension(100, 22));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(nome)
                                    .addComponent(codigoMotorista, javax.swing.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int id = Integer.parseInt(this.codigoMotorista.getText());

        Motorista motoristaChange = motoristaDAO.selecionarPorCodigo(id);

        if (motoristaChange != null) {

            String nomeValue = String.valueOf(this.nome.getText());

            Motorista newUser = new Motorista(id, nomeValue);
            motoristaDAO.editar(newUser);
    ...
    private javax.swing.JTextField codigoMotorista;
