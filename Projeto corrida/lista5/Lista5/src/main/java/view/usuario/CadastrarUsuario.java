...
public class CadastrarUsuario extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int codigo = Integer.parseInt(codigoUser.getText());
        String login = loginUser.getText();
        String senha = String.valueOf(senhaUser.getPassword());
        String nome = String.valueOf(nomeUser.getText());

        Usuario newUser = new Usuario(login, senha, codigo, nome);

        if (userDAO.consultarCodigo(codigo) != true) {

            userDAO.inserir(newUser);
            JOptionPane.showMessageDialog(null, "Usuário cadastrado com sucesso!");

        } else {
            JOptionPane.showMessageDialog(null, "Tente novamente, código ja existe!");
        }
