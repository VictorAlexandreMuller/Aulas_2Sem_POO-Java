...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        ListarProdutos t = ListarProdutos.getInstance();
    ...
    public static void main(String args[]) {
        ...
        // Importar os jars da pasta _jars e selecionar o tema do jar da pasta visual
        // O tema escolhido e edicionado neste menu principal será aplicado a todo o projeto
        // Código de try catch que altera o tema de acordo com a opcao escolhida no DEMO
        // O código precisa ser depois do Look and Feel
        try {
            FlatDarkPurpleIJTheme.setup(); // o .setup() precisou ser colocado, pois eh um tema do intelij
        } catch (Exception e) {
            e.printStackTrace();
        }
